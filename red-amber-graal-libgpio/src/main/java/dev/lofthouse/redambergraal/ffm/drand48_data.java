...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, gpiod_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, gpiod_h.C_SHORT).withName("__old_x"),
        gpiod_h.C_SHORT.withName("__c"),
        gpiod_h.C_SHORT.withName("__init"),
        gpiod_h.C_LONG_LONG.withName("__a")
