 ...
 * }
 */
public class gpiod_ctxless_event_poll_fd {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gpiod_h.C_INT.withName("fd"),
        gpiod_h.C_BOOL.withName("event"),
        MemoryLayout.paddingLayout(3)
    ).withName("gpiod_ctxless_event_poll_fd");
    ...
    private static final OfBoolean event$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("event"));
     ...
     * }
     */
    public static final OfBoolean event$layout() {
        return event$LAYOUT;
    }
     ...
     * }
     */
    public static boolean event(MemorySegment struct) {
     ...
     * }
     */
    public static void event(MemorySegment struct, boolean fieldValue) {
