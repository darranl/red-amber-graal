...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gpiod_h.C_INT.withName("__lock"),
        gpiod_h.C_INT.withName("__count"),
        gpiod_h.C_INT.withName("__owner"),
        gpiod_h.C_INT.withName("__nusers"),
        gpiod_h.C_INT.withName("__kind"),
        gpiod_h.C_SHORT.withName("__spins"),
        gpiod_h.C_SHORT.withName("__unused"),
    ...
    private static final long __unused$OFFSET = 22;
