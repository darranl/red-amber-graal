 ...
 * }
 */
public class gpiod_ctxless_event_poll_cb {
    ...
    private static final MethodHandle UP$MH = gpiod_h.upcallHandle(gpiod_ctxless_event_poll_cb.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(gpiod_ctxless_event_poll_cb.Function fi, Arena arena) {
