...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, gpiod_h.C_POINTER).withName("__locales"),
        gpiod_h.C_POINTER.withName("__ctype_b"),
        gpiod_h.C_POINTER.withName("__ctype_tolower"),
        gpiod_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, gpiod_h.C_POINTER).withName("__names")
