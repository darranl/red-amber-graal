...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gpiod_h.C_INT.withName("__readers"),
        gpiod_h.C_INT.withName("__writers"),
        gpiod_h.C_INT.withName("__wrphase_futex"),
        gpiod_h.C_INT.withName("__writers_futex"),
        gpiod_h.C_INT.withName("__pad3"),
        gpiod_h.C_INT.withName("__pad4"),
        gpiod_h.C_INT.withName("__cur_writer"),
        gpiod_h.C_INT.withName("__shared"),
        gpiod_h.C_LONG.withName("__pad1"),
        gpiod_h.C_LONG.withName("__pad2"),
        gpiod_h.C_INT.withName("__flags"),
