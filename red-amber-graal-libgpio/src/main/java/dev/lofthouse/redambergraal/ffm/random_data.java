...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gpiod_h.C_POINTER.withName("fptr"),
        gpiod_h.C_POINTER.withName("rptr"),
        gpiod_h.C_POINTER.withName("state"),
        gpiod_h.C_INT.withName("rand_type"),
        gpiod_h.C_INT.withName("rand_deg"),
        gpiod_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        gpiod_h.C_POINTER.withName("end_ptr")
