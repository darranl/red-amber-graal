...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gpiod_h.C_INT.withName("tm_sec"),
        gpiod_h.C_INT.withName("tm_min"),
        gpiod_h.C_INT.withName("tm_hour"),
        gpiod_h.C_INT.withName("tm_mday"),
        gpiod_h.C_INT.withName("tm_mon"),
        gpiod_h.C_INT.withName("tm_year"),
        gpiod_h.C_INT.withName("tm_wday"),
        gpiod_h.C_INT.withName("tm_yday"),
        gpiod_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        gpiod_h.C_LONG.withName("tm_gmtoff"),
        gpiod_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
